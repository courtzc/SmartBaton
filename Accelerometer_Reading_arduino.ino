...
void loop() {
  ...
  Serial.print(",");    // print a tab character, then the label for Y

  Serial.print(yAxis);      // print the value for the Y axis

  Serial.print(",");    // print a tab character, then the label for Z

  Serial.print(zAxis);    // print the value for the Z axis
