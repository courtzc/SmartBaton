...
%     niceTitle{4} = {sprintf("Reference average extraneous movement: %s", movementsShort{j})};
    ...
    % overall title
    axes('Position', [0, 0.85, 1, 0.18] ) ;
    set( gca, 'Color', 'None', 'XColor', 'White', 'YColor', 'White' ) ;
    text( 0.5, 0.2, niceTitle{1}, 'FontName', 'Arial', 'FontSize', 18', 'FontWeight', 'bold', ...
...
%       'HorizontalAlignment', 'Center', 'VerticalAlignment', 'middle' ) ;
    ...
    text( 0.5, 0.6, "Registration", 'FontName', 'Arial', 'FontSize', 16', 'FontWeight', 'bold', ...
      'HorizontalAlignment', 'Center', 'VerticalAlignment', 'middle' ) ; 
