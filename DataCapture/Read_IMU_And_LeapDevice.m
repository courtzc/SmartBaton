...
function Read_IMU_And_LeapDevice
    ...
    while(~KEY_IS_PRESSED)
        ...
        [IMU_reading, Leap_reading] = get_frame(s);
            ...
            fprintf("get_frame: %.2fms\t", duration) % it's the IMU frame that's occasionally slow. leap is consistently under 0.1ms. IMU is usually ~0.4ms, sometimes randomly 10 or 20ms.
            tic
