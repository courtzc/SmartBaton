...
function Step4_Rotate_Scaled_ResampledTrackingData_AbsoluteTime
    miniPattern = "C:\Users\Courtney\source\repos\ThesisProject\" + ...
        "Data\Session02_ManipulatedData\TrackingData_AbsoluteTime_Resampled_Scaled\*_11B_*.mat";
    ...
    for i = 1:length(theFiles)
        ...
        trackingDataShortFileName = sprintf("Session02_Exp_%s_BBaton_BlanksRemoved_SimpleCentroid_AbsoluteTimeCut_Resampled_Scaled", expID);
    %     trackingDataShortFileNameNew = sprintf("Session02_Exp_%s_BBaton_BlanksRemoved_SimpleCentroid_AbsoluteTimeCut_Resampled_Scaled", expID);
        trackingDataFileName = sprintf("Data/Session02_ManipulatedData/TrackingData_AbsoluteTime_Resampled_Scaled/%s.mat", trackingDataShortFileName);
    ...
    %     R = [cosd(45)  sind(45) 0; -sind(45) cosd(45) 0; 0 0 1]; % 45 degrees clockwise rotation
        ...
        % save new data
        fileName = sprintf("Data/Session02_ManipulatedData/TrackingData_AbsoluteTime_Resampled_Scaled_Rotated/%s_Rotated.mat", trackingDataShortFileName);
