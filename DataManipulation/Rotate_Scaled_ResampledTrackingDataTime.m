...
miniPattern = "C:\Users\Courtney\source\repos\ThesisProject\" + ...
    "Data\Session02_ManipulatedData\TrackingDataTime_Resampled_Scaled_Rotated\*_41C_*.mat";
...
for i = 1:length(theFiles)
    ...
    trackingDataShortFileName = sprintf("Session02_Exp_%s_BBaton_BlanksRemoved_SimpleCentroid_Resampled_Scaled_Rotated", expID);
    trackingDataFileName = sprintf("Data/Session02_ManipulatedData/TrackingDataTime_Resampled_Scaled_Rotated/%s.mat", trackingDataShortFileName);
...
%     R = [cosd(45)  sind(45) 0; -sind(45) cosd(45) 0; 0 0 1]; % 45 degrees clockwise rotation
    ...
    % save new data
    fileName = sprintf("Data/Session02_ManipulatedData/TrackingDataTime_Resampled_Scaled_Rotated/%s.mat", trackingDataShortFileName);
